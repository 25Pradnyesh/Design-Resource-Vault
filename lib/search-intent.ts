...
const STYLE_MAP: Record<string, string> = {
  ...
  typogr: "Typography-Heavy",
  typo: "Typography-Heavy",
...
const CATEGORY_KEYWORDS: Record<string, string> = {
  ...
  port: "portfolio-inspiration",
  portf: "portfolio-inspiration",
  ...
  anim: "website-animation-inspiration",
  microinteraction: "website-animation-inspiration",
  "motion tools": "animation-motion-tools",
  "motion tool": "animation-motion-tools",
  "motion des": "animation-motion-tools",
